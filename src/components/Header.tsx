...
export default function Header() {
  ...
  return (
    <>
      {/* Top Info Bar */}
      <div className="bg-blue-900 text-blue-50 text-main py-4 px-4 font-raleway">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-4 items-start text-center sm:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:justify-start gap-2">
            <div className="flex items-center gap-2">
              <span className="font-semibold">220 Butler Ave., Durham, NC</span>
            </div>
            <a
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <div className="flex items-center gap-2 text-xs">
              ...
              <div className="flex flex-col">
                <span className="font-semibold">Mon–Thur: 8am–5:30pm</span>
                <span className="font-semibold">Fri: 8am–5:00pm</span>
              </div>
            </div>            
      ...
      <header className="bg-blue-50 shadow-md top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 grid grid-cols-3 items-center">
          ...
          {/* Center: Nav */}
          <nav className="hidden md:flex justify-center space-x-8 font-raleway tracking-wide text-xl">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
